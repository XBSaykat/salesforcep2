...
import net.maxproit.salesforce2.ProspectViewRbm;
...
public class ActivityUtils {
    ...
    public static void invokVisitPlanDetail(Activity activity, Class<?> tClass, net.maxproit.salesforce2.masum.model.api.myactivity.Data visitPlan) {
        Bundle bundle = new Bundle();
        bundle.putSerializable(AppConstant.INTENT_KEY, visitPlan);

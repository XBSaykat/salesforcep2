package net.maxproit.salesforce2.masum.adapter.adapterplanlist;
...
//            });
    ...
    @Override
    public PreviousPlanListAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.item_visit_plan, null);
        PreviousPlanListAdapter.CustomViewHolder viewHolder = new PreviousPlanListAdapter.CustomViewHolder(view, context, leadList);
        return viewHolder;
    }

package net.maxproit.salesforce2.masum.reciever;
...
import net.maxproit.salesforce2.masum.utility.NetworkUtil;
        ...
        if (status) {
            ...
            if (visitPlanList.size() > 0) {
                for (int i = 0; i < visitPlanList.size(); i++) {
                    ...
                    net.maxproit.salesforce2.masum.model.api.visitPlan.Data data = new net.maxproit.salesforce2.masum.model.api.visitPlan.Data();

...
import net.maxproit.salesforce2.databinding.ActivityNewDeviationBinding;
import net.maxproit.salesforce2.masum.activity.DeviationActivity;
import net.maxproit.salesforce2.masum.activity.daviation.adapter.NewDaviationAdapter;

...
import net.maxproit.salesforce2.masum.fragment.prospect.prospectstage.PropectStageAttachmentFragment;
import net.maxproit.salesforce2.masum.fragment.prospect.prospectstage.ProspectStageCoApplicantFragment;
import net.maxproit.salesforce2.masum.fragment.prospect.prospectstage.ProspectStageFinancialFragment;
import net.maxproit.salesforce2.masum.fragment.prospect.prospectstage.ProspectStageLoanAndSecurityDetailFragment;
import net.maxproit.salesforce2.masum.fragment.prospect.prospectstage.ProspectStageProductAndCustomerDetailsFragment;
                ...
                if (isNetworkAvailable()) {
                    ...
                    getApiService().myNewProspect(newProspectUpdate).enqueue(new Callback<OldPostpectResponse>() {
                        ...
                        public void onResponse(Call<OldPostpectResponse> call, Response<OldPostpectResponse> response) {
                            if (response.isSuccessful()) {
                                if (response.body().getCode().equals(getString(R.string.success_code))) {
                                    net.maxproit.salesforce2.masum.model.prospectmodel.Data data = response.body().getData();
...
// String status, String remark, String user, String branch, int productId
    ...
    private void leadApprove(net.maxproit.salesforce2.masum.model.prospectmodel.Data data, int productId) {

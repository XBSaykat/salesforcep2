package net.maxproit.salesforce2.masum.activity.visitplan;
...
import net.maxproit.salesforce2.databinding.ActivityVisitPlanListBinding;
import net.maxproit.salesforce2.feature.supervisor.adapter.AdapterInfo;
import net.maxproit.salesforce2.masum.adapter.adapterplanlist.MyVisitPlanListAdapter;
import net.maxproit.salesforce2.masum.appdata.AppConstant;
import net.maxproit.salesforce2.masum.appdata.sqlite.FollowUpDbController;
import net.maxproit.salesforce2.masum.listener.OnItemClickListener;
import net.maxproit.salesforce2.masum.model.api.visitPlan.Datum;

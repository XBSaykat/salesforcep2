...
import net.maxproit.salesforce2.databinding.ActivityMyPerformancePhaseTwoBinding;
import net.maxproit.salesforce2.masum.adapter.myperformacecountadapter.MyPerformanceItemAdapter;

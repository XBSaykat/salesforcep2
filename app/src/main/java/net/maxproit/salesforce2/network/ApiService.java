package net.maxproit.salesforce2.network;
...
import net.maxproit.salesforce2.masum.model.api.deviation.deviationresponse.DeviationPostRespose;
...
import net.maxproit.salesforce2.masum.model.api.followup.FollowUpHistoryApi;
...
import net.maxproit.salesforce2.masum.model.api.performance.Getperformance;
import net.maxproit.salesforce2.masum.model.api.rbm.GetRbmData;
import net.maxproit.salesforce2.masum.model.api.useractivity.UserRegistration;
import net.maxproit.salesforce2.masum.model.api.visitPlan.MyVisitPlanApi;
import net.maxproit.salesforce2.masum.model.api.visitPlan.MyVisitPlanGetApi;
import net.maxproit.salesforce2.masum.model.prospectmodel.OldPostpectResponse;
...
import net.maxproit.salesforce2.model.cif.notRequestedCIF.NotRequestedCifData;
import net.maxproit.salesforce2.model.cif.post.CifPost;
import net.maxproit.salesforce2.model.cif.postResponce.CifPostResponce;
import net.maxproit.salesforce2.model.cif.requestedCIf.RequestedCIfData;
import net.maxproit.salesforce2.model.deviation.DeviationEntities;
import net.maxproit.salesforce2.model.folowup.FollowupList;
import net.maxproit.salesforce2.model.login.Login;
import net.maxproit.salesforce2.model.login.LoginResponse;
import net.maxproit.salesforce2.model.mylead.MyLeadApproval;
import net.maxproit.salesforce2.model.mylead.Mylead;
import net.maxproit.salesforce2.model.mylead.approvalresponce.ApprovalResponce;
import net.maxproit.salesforce2.model.mylead.updateLead.OldLead;
import net.maxproit.salesforce2.model.myprospect.MyProspect;
import net.maxproit.salesforce2.model.myprospect.documentlist.ProspectDocList;
...
import net.maxproit.salesforce2.model.newprospect.mynewprosppect.NewProspectUpdate;
import net.maxproit.salesforce2.model.salesOfficer.disbursement.Disbursement;
import net.maxproit.salesforce2.model.salesOfficer.myPerfomance.MyPerfomance;
import net.maxproit.salesforce2.model.sd.DisbursementList;
import net.maxproit.salesforce2.model.search.DisbursementSearch;
import net.maxproit.salesforce2.model.search.Search;
import net.maxproit.salesforce2.model.search.guarantor.SearchGuarantor;
import net.maxproit.salesforce2.model.search.proprietor.SearchProprietor;
import net.maxproit.salesforce2.model.search.searchlist.SearchList;
import net.maxproit.salesforce2.model.search.searchlist.disbursementsearch.DisbursementItemData;
import net.maxproit.salesforce2.model.search.searchlist.disbursementsearch.DisbursementSearchResponceList;
import net.maxproit.salesforce2.model.setting.GlobalSettings;
import net.maxproit.salesforce2.model.supervisor.calls.Calls;
...
import net.maxproit.salesforce2.model.supervisor.salesofficers.SalesOfficers;
import net.maxproit.salesforce2.model.supervisor.sanctions.Sanctions;
...
import net.maxproit.salesforce2.model.virifier.virifierlist.Virifier;
...
public interface ApiService {
    ...
    Call<MyVisitPlanApi> createVisitPlan(@Body net.maxproit.salesforce2.masum.model.api.visitPlan.Data data);
...
// @POST("CdProspect/Prospect")
//    Call<OldPostpectResponse> myNewProspectData(@Body net.maxproit.salesforce2.masum.model.prospectmodel.Data newProspectUpdate);
    ...
    @POST("GeoLocation")
    Call<GetGpsResponse> sendltdlng(@Body net.maxproit.salesforce2.masum.model.api.gpstracker.Data data);
...
//    Call<DevAccountHeadEntities> deviationHeadById(@Path("id") String id);
    ...
    Call<net.maxproit.salesforce2.masum.model.api.deviation.deviationaccounthead.DevAccountHeadEntities> deviationHeadById(@Path("deviationCatId") String deviationCatId,

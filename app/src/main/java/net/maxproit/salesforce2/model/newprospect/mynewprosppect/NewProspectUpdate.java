package net.maxproit.salesforce2.model.newprospect.mynewprosppect;
...
import net.maxproit.salesforce2.model.myprospect.updatemyprospect.CoApplicant;
...
public class NewProspectUpdate {
    ...
    public ArrayList<CoApplicant> setCoApplicantsFromProspect(ArrayList<net.maxproit.salesforce2.masum.model.local.CoApplicant> coApplicanLocalList) {
    ...
    public void getDBCoApplicants(ArrayList<net.maxproit.salesforce2.masum.model.local.CoApplicant> coApplicantList) {

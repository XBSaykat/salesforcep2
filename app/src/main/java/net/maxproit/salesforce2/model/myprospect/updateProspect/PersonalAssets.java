...
public class PersonalAssets {
    ...
    public net.maxproit.salesforce2.model.newprospect.PersonalAssetsType getTypec() {
        return new net.maxproit.salesforce2.model.newprospect.PersonalAssetsType(
    ...
    public net.maxproit.salesforce2.model.newprospect.PersonalAssetsPropertytype getPropertytypec() {
        return new net.maxproit.salesforce2.model.newprospect.PersonalAssetsPropertytype(propertytype.getPropertyTypeCode(),propertytype.getPropertyType());
    }

...
package net.maxproit.salesforce2.model.leadstage;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

import net.maxproit.salesforce2.model.newlead.Address;
...
public class NewLead {
    ...
    public List<Address> getOldAddresses(List<net.maxproit.salesforce2.model.mylead.updateLead.Address> addresses) {

        List<Address> list = new ArrayList<>();
        for (net.maxproit.salesforce2.model.mylead.updateLead.Address a : addresses) {
    ...
    public List<VisitRecord> getOldVisitRecords(List<net.maxproit.salesforce2.model.mylead.updateLead.VisitRecord> visitRecords) {
        List<VisitRecord> list = new ArrayList<>();

        for (net.maxproit.salesforce2.model.mylead.updateLead.VisitRecord v : visitRecords) {

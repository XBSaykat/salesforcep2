...
import net.maxproit.salesforce2.databinding.SupervisorDisRowBinding;
import net.maxproit.salesforce2.feature.salesOfficer.SalesOfficerDisbursementActivity;
 ...
 * heyRezwan@gmail.com
 */
public class SupervisorDisbursementAdapter extends RecyclerView.Adapter<SupervisorDisbursementAdapter.ViewFilesHolder> {
     ...
     */
    public SupervisorDisbursementAdapter(Context context, List<User> dataList) {
    ...
    public ViewFilesHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        SupervisorDisRowBinding binding =
                DataBindingUtil.inflate(layoutInflater, R.layout.supervisor_dis_row, parent, false);
    ...
    public void onBindViewHolder(ViewFilesHolder holder, int position) {
        ...
        holder.binding.clLeadItem.setOnClickListener(v -> {
            ...
            context.startActivity(new Intent(context, SalesOfficerDisbursementActivity.class));
        });
    ...
    public class ViewFilesHolder extends RecyclerView.ViewHolder {
        ...
        private final SupervisorDisRowBinding binding;

        public ViewFilesHolder(final SupervisorDisRowBinding itemBinding) {

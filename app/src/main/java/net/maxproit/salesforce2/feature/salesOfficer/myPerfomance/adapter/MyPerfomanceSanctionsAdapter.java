...
import net.maxproit.salesforce2.databinding.SalesofficerSanctionsRowBinding;
...
import net.maxproit.salesforce2.model.supervisor.sanctions.Datum;
 ...
 * heyRezwan@gmail.com
 */
public class MyPerfomanceSanctionsAdapter extends RecyclerView.Adapter<MyPerfomanceSanctionsAdapter.ViewFilesHolder> {
     ...
     */
    public MyPerfomanceSanctionsAdapter(Context context, List<Datum> dataList) {
    ...
    public ViewFilesHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        SalesofficerSanctionsRowBinding binding =
                DataBindingUtil.inflate(layoutInflater, R.layout.salesofficer_sanctions_row, parent, false);
...
//                    bundle.putString(CurrentLevel, list.get(position).getCurrentLevel());
    ...
    public class ViewFilesHolder extends RecyclerView.ViewHolder {
        ...
        private final SalesofficerSanctionsRowBinding binding;

        public ViewFilesHolder(final SalesofficerSanctionsRowBinding itemBinding) {

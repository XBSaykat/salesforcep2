...
import net.maxproit.idlc.databinding.SupervisorProspectMainRowBinding;
import net.maxproit.idlc.databinding.SupervisorProspectRowBinding;
import net.maxproit.idlc.feature.salesOfficer.myPerfomance.MyPerfomanceProspectActivity;
import net.maxproit.idlc.model.login.LocalLogin;
import net.maxproit.idlc.model.myprospect.updateProspect.OleProspect;
import net.maxproit.idlc.model.supervisor.prospects.Datum;

package net.maxproit.idlc.feature.search;
...
import net.maxproit.idlc.common.base.Clicklistener;
import net.maxproit.idlc.databinding.ActivitySearchUserBinding;
import net.maxproit.idlc.feature.search.adapter.SearchAdapter;

...
import net.maxproit.idlc.databinding.ActivitySupervisorMaiProspectBinding;
import net.maxproit.idlc.feature.supervisor.adapter.AdapterInfo;
import net.maxproit.idlc.feature.supervisor.adapter.SupervisorMainProspectsAdapter;

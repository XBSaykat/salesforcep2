...
import net.maxproit.idlc.databinding.ActivitySupervisorSanctionBinding;
import net.maxproit.idlc.feature.salesOfficer.myPerfomance.adapter.MyPerfomanceSanctionsAdapter;

package net.maxproit.idlc.feature.salesOfficer.parallelprocess;
...
import net.maxproit.idlc.databinding.ActivityDeviationBinding;
import net.maxproit.idlc.feature.supervisor.adapter.UtilSpinner;
import net.maxproit.idlc.model.deviation.head.DevAccountHead;
import net.maxproit.idlc.model.deviation.head.DevAccountHeadEntities;
import net.maxproit.idlc.model.deviation.post.DeviationDetail;
import net.maxproit.idlc.model.deviation.post.DeviationHead;
import net.maxproit.idlc.model.deviation.post.DeviationPost;
import net.maxproit.idlc.model.setting.DeviationCategory;
...
public class DeviationActivity extends BaseActivity {
    ...
    private void nextRequest() {
        ...
        deviationDetail.setDeviationCategory(new net.maxproit.idlc.model.deviation.post.DeviationCategory(dvCategoryId, dvcategory));

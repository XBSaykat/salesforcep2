...
import net.maxproit.idlc.databinding.ActivityNewleadBinding;
...
import net.maxproit.idlc.model.newlead.BasicInfo;
...
import net.maxproit.idlc.util.GoogleLandMark;

package net.maxproit.idlc.feature.virifier.adapter;
...
import net.maxproit.idlc.databinding.VirifierListRowBinding;
...
import net.maxproit.idlc.model.virifier.virifierlist.Datum;

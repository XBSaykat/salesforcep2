...
import net.maxproit.idlc.databinding.SupervisorCallsRowBinding;
import net.maxproit.idlc.feature.supervisor.adapter.AdapterInfo;
import net.maxproit.idlc.model.folowup.Followup;
import net.maxproit.idlc.model.login.LocalLogin;
import net.maxproit.idlc.model.supervisor.calls.Datum;

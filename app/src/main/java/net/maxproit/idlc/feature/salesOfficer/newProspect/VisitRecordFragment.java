...
import net.maxproit.idlc.databinding.FragmentVisitRecordBinding;
import net.maxproit.idlc.databinding.VisitRecordProspectBinding;
...
public class VisitRecordFragment extends BaseFragment {
    ...
    List<net.maxproit.idlc.model.newlead.VisitRecord> vrList = new ArrayList<>();
    ...
    protected void initFragmentComponents() {
        ...
        binding.addbuton.setOnClickListener(v -> {
            ...
            c.setModel(new net.maxproit.idlc.model.newlead.VisitRecord());
            ...
            // TODO : - Only Test
            net.maxproit.idlc.model.newlead.VisitRecord vr = c.getModel();

package net.maxproit.idlc.feature.salesOfficer.parallelprocess.cib;
...
import net.maxproit.idlc.databinding.ActivityCibNewBinding;
import net.maxproit.idlc.feature.salesOfficer.parallelprocess.cib.adapter.NotRequestCibAdapter;
import net.maxproit.idlc.feature.salesOfficer.parallelprocess.cif.CifActivity;
import net.maxproit.idlc.feature.salesOfficer.parallelprocess.cif.CifActivityNew;
import net.maxproit.idlc.feature.salesOfficer.parallelprocess.cif.CifDialog;
import net.maxproit.idlc.feature.supervisor.adapter.AdapterInfo;
import net.maxproit.idlc.model.cib.notRequestedCIB.NotRequestedCIB;
import net.maxproit.idlc.model.cib.notRequestedCIB.NotRequestedCIBData;
import net.maxproit.idlc.model.cib.post.CibRequestDtl;
import net.maxproit.idlc.model.cif.notRequestedCIF.NotRequestedCif;
import net.maxproit.idlc.model.cif.post.CifRequestDtl;

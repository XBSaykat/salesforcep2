...
public class SharedPreferencesEnum {
     ...
     */
    public enum Key {
        SERVICE_URL, COMPANY_DB, PASS_CODE, DEFAULT_CUSTOMER_NAME, USER_ID, SALES_SEARCH_TYPE_RADIO_BUTTON, WAREHOUSE_ID, USER_TYPE, API_KEY, LOAN, USER_NAME, USER_LOANAMOUNT, USER_BRANCH, LOANAPPROVED, LOANAPPROVED_ID, LOAN_SUBMIT, ROLLUSER, TEST, ROLLUSERINFO, PASSWORD, SETTING, LOCA_LLOGIN, LEADPDF1, LEADPDF2, ADDRESS, ADDRESS_POSITION, GUARANTOR_INFO, GUARANTOR_INFO_POSITION, PERSONAL_ASSETS, PERSONAL_ASSETS_POSITION, OWNERS_INFO, OWNERS_INFO_POSITION, FTYPE, SEARCH_TYPE, DAVIATION_LIST, USER_NAME_PER, DEV_SEARCH, DEFAULT_CUSTOMER_ID

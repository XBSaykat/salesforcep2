package net.maxproit.idlc.model.search.guarantor;
...
public class SearchGuarantor {
    ...
    public net.maxproit.idlc.model.newprospect.GuarantorsInfo getData() {

        net.maxproit.idlc.model.newprospect.GuarantorsInfo guarantorsInfo = new net.maxproit.idlc.model.newprospect.GuarantorsInfo(

...
import net.maxproit.idlc.model.newlead.Address;
...
public class NewLead {
    ...
    public List<Address> getOldAddresses(List<net.maxproit.idlc.model.mylead.updateLead.Address> addresses) {

        List<Address> list = new ArrayList<>();
        for (net.maxproit.idlc.model.mylead.updateLead.Address a : addresses) {
    ...
    public List<VisitRecord> getOldVisitRecords(List<net.maxproit.idlc.model.mylead.updateLead.VisitRecord> visitRecords) {
        List<VisitRecord> list = new ArrayList<>();

        for (net.maxproit.idlc.model.mylead.updateLead.VisitRecord v : visitRecords) {

...
import net.maxproit.idlc.model.newlead.VisitRecord;
import net.maxproit.idlc.model.newprospect.GeneralInfo;
...
import net.maxproit.idlc.model.newprospect.Verification;
...
public class OleProspect {
    ...
    public NewProspect getNewProspect() {
        ...
        for (net.maxproit.idlc.model.myprospect.updateProspect.GuarantorsInfo gf : getData().getGuarantorsInfo()) {
            ...
            if (gf.getAddresses().size() > 0) {
                List<net.maxproit.idlc.model.newprospect.Address> adg = new ArrayList<>();

                for (net.maxproit.idlc.model.myprospect.updateProspect.Address v : getData().getGuarantorsInfo().get(0).getAddresses()) {
                    adg.add(new net.maxproit.idlc.model.newprospect.Address(
                            v.getAddressID(),
                            v.getAddressType(),
                            v.getArea(),
                            v.getVillage(),
        ...
        for (net.maxproit.idlc.model.myprospect.updateProspect.ProprietorsInfo preof : getData().getProprietorsInfo()) {
            ...
            if (preof.getAddresses().size() > 0) {
                List<net.maxproit.idlc.model.newprospect.Address> adprop = new ArrayList<>();

                for (net.maxproit.idlc.model.myprospect.updateProspect.Address v : preof.getAddresses()) {
            ...
            if (preof.getPersonalAssets().size() > 0) {
                ...
                for (net.maxproit.idlc.model.myprospect.updateProspect.PersonalAssets v : preof.getPersonalAssets()) {
        ...
        for (net.maxproit.idlc.model.myprospect.updateProspect.VisitRecord v : getData().getVisitRecords()) {
        ...
        List<net.maxproit.idlc.model.newprospect.Address> prospectAddress = new ArrayList<>();
        if (getData().getProspectAddresses().size() > 0) {
            for (net.maxproit.idlc.model.myprospect.updateProspect.ProspectAddress v : getData().getProspectAddresses()) {
                prospectAddress.add(new net.maxproit.idlc.model.newprospect.Address(
                        v.getAddressID(),
                        v.getAddressType(),
                        v.getArea(),
                        v.getVillage(),

...
import net.maxproit.salesforce.databinding.FragmentOwnersPersonalAssetsBinding;
import net.maxproit.salesforce.feature.salesOfficer.newProspect.ownersinfo.adapter.OwnersInfoAssetsAdapter;
...
public class PersonalAssetsFragment extends BaseFragment {
    ...
    protected void initFragmentComponents() {
        ...
        binding.btnAdd.setOnClickListener(v -> {
            ...
            net.maxproit.salesforce.util.SharedPreferencesEnum.getInstance().put(SharedPreferencesEnum.Key.PERSONAL_ASSETS,date);

...
import net.maxproit.salesforce.databinding.ActivitySupervisorProspectBinding;
import net.maxproit.salesforce.feature.supervisor.adapter.AdapterInfo;
import net.maxproit.salesforce.feature.supervisor.adapter.SupervisorProspectsAdapter;

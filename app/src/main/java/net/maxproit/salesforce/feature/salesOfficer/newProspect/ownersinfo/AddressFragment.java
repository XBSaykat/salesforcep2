...
import net.maxproit.salesforce.feature.salesOfficer.newProspect.guarantorinfo.GuarantorAddressActivity;
...
public class AddressFragment extends BaseFragment implements Clicklistener {
    ...
    protected void initFragmentComponents() {
        ...
        binding.btnAdd.setOnClickListener(v -> {
            ...
            net.maxproit.salesforce.util.SharedPreferencesEnum.getInstance().put(SharedPreferencesEnum.Key.ADDRESS, date);
    ...
    private void setAdapter() {
        ...
        adapter.setContext(new net.maxproit.salesforce.feature.salesOfficer.newProspect.guarantorinfo.AddressFragment());

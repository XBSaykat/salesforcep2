...
import net.maxproit.salesforce.databinding.ActivitySupervisorMaiProspectBinding;
import net.maxproit.salesforce.feature.supervisor.adapter.AdapterInfo;
import net.maxproit.salesforce.feature.supervisor.adapter.SupervisorMainProspectsAdapter;

...
public class PersonalAssets {
    ...
    public net.maxproit.salesforce.model.newprospect.PersonalAssetsType getTypec() {
        return new net.maxproit.salesforce.model.newprospect.PersonalAssetsType(
    ...
    public net.maxproit.salesforce.model.newprospect.PersonalAssetsPropertytype getPropertytypec() {
        return new net.maxproit.salesforce.model.newprospect.PersonalAssetsPropertytype(propertytype.getPropertyTypeCode(),propertytype.getPropertyType());
    }

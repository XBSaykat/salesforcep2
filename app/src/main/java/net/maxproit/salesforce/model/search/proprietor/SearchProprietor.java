package net.maxproit.salesforce.model.search.proprietor;
...
public class SearchProprietor {
    ...
    public net.maxproit.salesforce.model.newprospect.ProprietorsInfo getData() {

        net.maxproit.salesforce.model.newprospect.ProprietorsInfo proprietorsInfo = new net.maxproit.salesforce.model.newprospect.ProprietorsInfo(
        ...
        if (data.getPersonalAssets().size() > 0) {
            ...
            for (net.maxproit.salesforce.model.myprospect.updateProspect.PersonalAssets v : data.getPersonalAssets()) {
